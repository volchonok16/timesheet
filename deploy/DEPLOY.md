...
|----------|--------------------------|--------------------|
| Frontend | https://mateplace.ru     | `127.0.0.1:5173`   |
| API      | https://api.mateplace.ru | `127.0.0.1:8000`   |
...
| Файл | Назначение |
|------|------------|
| `deploy/nginx/docker.conf` | nginx в Docker (локальный `:8080`) |
...
curl -sI -H 'Host: localhost' http://127.0.0.1:5173/
```
